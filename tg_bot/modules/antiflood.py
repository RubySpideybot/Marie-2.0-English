...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    try:
        ...
        msg.reply_text(f"{mention_html(user.id, user.first_name)} is muted, due to more consecutive messages...", parse_mode=ParseMode.HTML)
...
def flood(bot: Bot, update: Update):
    ...
    if limit == 0:
        ...
        update.effective_message.reply_text(
            " {} is the limit, I'll mute the person who sends the messages more at the same time.".format(limit))
